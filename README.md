...
* ![Query 1.A - JOIN](./Stage_2/Screenshots/1.A.png)
* ![Query 1.B - EXISTS](./Stage_2/Screenshots/1.B.png)
...
* ![Query 2.A - JOIN](./Stage_2/Screenshots/2.A.png)
* ![Query 2.B - IN](./Stage_2/Screenshots/2.B.png)
...
* ![Query 3.A - JOIN](./Stage_2/Screenshots/3.A.png)
* ![Query 3.B - EXISTS](./Stage_2/Screenshots/3.B.png)
...
* ![Query 4.A - JOIN](./Stage_2/Screenshots/4.A.png)
* ![Query 4.B - Nested IN](./Stage_2/Screenshots/4.B.png)
...
* ![Query 5](./Stage_2/Screenshots/5.png)
...
* ![Query 6](./Stage_2/Screenshots/6.png)
...
* ![Query 7](./Stage_2/Screenshots/7.png)
...
* ![Query 8](./Stage_2/Screenshots/8.png)
...
* **Before:** ![Update 1 Before](./Stage_2/Screenshots/bot_to_change.png)
* **Execution:** ![Update 1 Run](./Stage_2/Screenshots/bot_change.png)
* **After:** ![Update 1 After](./Stage_2/Screenshots/bot_after_change.png)
...
* **Before:** ![Update 2 Before](./Stage_2/Screenshots/Node_to_change.png)
* **Execution:** ![Update 2 Run](./Stage_2/Screenshots/Node_change.png)
* **After:** ![Update 2 After](./Stage_2/Screenshots/Node_after_change.png)
...
* **Before:** ![Update 3 Before](./Stage_2/Screenshots/Eval_to_change.png)
* **Execution:** ![Update 3 Run](./Stage_2/Screenshots/Eval_change.png)
* **After:** ![Update 3 After](./Stage_2/Screenshots/Eval_after_change.png)
...
* **Before:** ![Delete 1 Before](./Stage_2/Screenshots/Del1before.png)
* **Execution:** ![Delete 1 Run](./Stage_2/Screenshots/Del1.png)
* **After:** ![Delete 1 After](./Stage_2/Screenshots/Del1after.png)
...
* **Before:** ![Delete 2 Before](./Stage_2/Screenshots/Del2before.png)
* **Execution:** ![Delete 2 Run](./Stage_2/Screenshots/Del2.png)
* **After:** ![Delete 2 After](./Stage_2/Screenshots/Del2after.png)

**Delete 3: Deprecate Legacy Web UI Support**
* **Description:** Deletes support records for Web UIs released before the year 2026.
* **Before:** ![Delete 3 Before](./Stage_2/Screenshots/Del3before.png)
* **Execution:** ![Delete 3 Run](./Stage_2/Screenshots/Del3.png)
* **After:** ![Delete 3 After](./Stage_2/Screenshots/Del3after.png)
...
3. **Prevent Duplicate Bot Names (`UNIQUE`):** Restricts the same engine from operating two distinct bots with identical display names.
   * ![Constraint 3 Error](./Stage_2/Screenshots/Con3.png)
...
1. **Telemetry Date Index:** The `HardwareTelemetry` table contains tens of thousands of rows. System monitoring relies heavily on timestamp filtering. Indexing the `time_stamp` column significantly reduced query execution time.
   * **Before:** ![Index 1 Before](./Stage_2/Screenshots/In1before.png) | **After:** ![Index 1 After](./Stage_2/Screenshots/In1after.png)
2. **Evaluation Score Index:** To quickly retrieve the best chess lines from the massive `EngineEvaluation` table, we applied an index on the `eval_score_cp` column, skipping full sequential scans.
   * **Before:** ![Index 2 Before](./Stage_2/Screenshots/In2before.png) | **After:** ![Index 2 After](./Stage_2/Screenshots/In2after.png)
3. **Foreign Key Index (Bot -> Engine):** PostgreSQL does not automatically index foreign keys. Creating a manual index on `engine_id` in the `Bot` table drastically accelerated `JOIN` operations between the two tables.
   * **Before:** ![Index 3 Before](./Stage_2/Screenshots/In3before.png) | **After:** ![Index 3 After](./Stage_2/Screenshots/In3after.png)
...
1. **Rollback (Server Memory Update Reversal):** We initiated an update to increase a server's RAM from 256GB to 1024GB, then executed a `ROLLBACK` to revert the table to its initial state.
   * **Initial State:** ![Rollback Before](./Stage_2/Screenshots/R1before.png)
   * **Mid-Transaction:** ![Rollback Mid](./Stage_2/Screenshots/R1.png)
   * **Reverted State:** ![Rollback After](./Stage_2/Screenshots/R1after.png)
2. **Commit (Permanent Bot Update):** We upgraded a bot's difficulty to level 9 and executed a `COMMIT` to permanently save the changes to the database.
   * **Initial State:** ![Commit Before](./Stage_2/Screenshots/R2before.png)
   * **Mid-Transaction:** ![Commit Mid](./Stage_2/Screenshots/R2.png)
   * **Saved State:** ![Commit After](./Stage_2/Screenshots/R2after.png)