...
[**Click here to view the full Data Dictionary and Specification Document (PDF)**](./Data_Dictionary.pdf)
...
![Relational Schema Diagram](./schema.png)
...
2. **Using Mockaroo:** Generating approximately 500 automated rows for the Bot table.
   ![Mockaroo Proof](./mockarooScreenshot.png)
3. **Big Data Insertion via Python:**
   ...
   ![Python Execution Proof](./pythonEXEProof.png)
...
![Successful Backup Proof](./BackupScreenshot.png)